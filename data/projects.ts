...
* **Live Demo:** [https://private-ai-note.vercel.app](https://private-ai-note.vercel.app/)
    ...
    featured: true,
    highlights: ["100% Offline AI", "Privacy-first architecture", "On-device intelligence"],
  },
  {
    id: "findcare",
    title: "FindCare",
...
* **Live Demo:** [https://find-care.netlify.app](https://find-care.netlify.app/)
    ...
    featured: true,
    highlights: ["AI-assisted diagnosis", "Patient-practitioner matching", "Structured medical summaries"],
  },
  {
...
* 🎥 **YouTube Demo:** [https://youtube.com/shorts/_0H_HvfSh0w](https://youtube.com/shorts/_0H_HvfSh0w)
    ...
    featured: true,
    highlights: ["Automated tuition payments", "AI-driven smart savings", "Micro-investment platform"],
  },
  // {
  //     id: "nexus-saas",

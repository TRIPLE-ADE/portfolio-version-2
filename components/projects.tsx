                            ...
                            <Card className="group relative h-full overflow-hidden transition-all hover:border-primary hover:shadow-lg border-0.75 dark:shadow-[0px_0px_27px_0px_#2D2D2D]">
                                ...
                                <div className="relative aspect-video overflow-hidden bg-black">
                                    <ProjectVideoPlayer
                                        ...
                                        isActive={true}
                                    />
                                    {/* Link overlay over the video part */}
                                    <Link href={`/projects/${project.id}`} className="absolute inset-0 z-30" />

                                    <div className="absolute inset-0 bg-gradient-to-t from-background/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6 z-20 pointer-events-none">
